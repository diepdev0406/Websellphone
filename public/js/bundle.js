...
if (userPasswordForm) userPasswordForm.addEventListener("submit", async (e)=>{
    ...
    document.querySelector(".btn--save-password").textContent = "L\u01B0u thay \u0111\u1ED5i";
    document.getElementById("password-current").value = "";
    document.getElementById("password").value = "";
    document.getElementById("password-confirm").value = "";
});

},{"core-js/modules/es.symbol.description.js":"hgu4d","core-js/modules/es.array.flat.js":"lRn13","core-js/modules/es.array.flat-map.js":"gM669","core-js/modules/es.array.sort.js":"PLp5i","core-js/modules/es.array.unscopables.flat.js":"88nm6","core-js/modules/es.array.unscopables.flat-map.js":"2tF7j","core-js/modules/es.math.hypot.js":"bPuQ3","core-js/modules/es.object.from-entries.js":"98OZX","core-js/modules/es.promise.js":"5t0IQ","core-js/modules/es.promise.finally.js":"c5ALq","core-js/modules/es.regexp.flags.js":"kZ4xK","core-js/modules/es.typed-array.set.js":"8AABK","core-js/modules/es.typed-array.sort.js":"gqGeA","core-js/modules/web.queue-microtask.js":"eRNJq","./login":"qZEOz","./updateSettings":"28JcJ"}],"hgu4d":[function(require,module,exports) {
...
const updateSettings = async (data, type)=>{
    try {
        ...
        // console.log(res);
        if (res.data.status === "success") (0, _alerts.showAlert)("success", `${type.toUpperCase()} update successfully`);
    } catch (err) {
        // console.log(err);
        (0, _alerts.showAlert)("error", err.response.data.message);
    }
...
},{"./alerts":"j4hQk","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}]},["lImHF","4uyBp"], "4uyBp", "parcelRequireb7cd")
